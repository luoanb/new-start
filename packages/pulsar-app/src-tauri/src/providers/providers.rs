use super::openai_compat::{self, ChatMessage, ChatRequest, FunctionDef, ToolDef};
use crate::core::{
...
impl ProviderRegistry {
    ...
    pub async fn call_model(&self, request: ModelRequest) -> AppResult<ModelResponse> {
    ...
    fn parse_chat_response(
        ...
        let tool_calls: Option<Vec<crate::core::models::AuthorizedToolCall>> = choice
            .message
            .tool_calls
            .as_ref()
            .map(|calls| {
                calls
                    ...
                    .filter_map(|tc| {
                        ...
                        Some(crate::core::models::AuthorizedToolCall {
                            id: tc.id.clone(),
                            name,
                            arguments: args,
                        })
    ...
    fn validate_request(&self, request: &ModelRequest) -> AppResult<()> {
...
#[async_trait]
impl crate::core::round_executor::ModelCaller for ProviderRegistry {
    ...
    async fn call_model_stream(
        ...
        ProviderRegistry::call_model_stream(self, request, on_chunk).await
    }
}
