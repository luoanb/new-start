<script lang="ts">
  ...
  const modes = [
    { id: "chat", label: "Chat", desc: "Simple conversation, no tools." },
    { id: "agent", label: "Agent", desc: "Can call tools for tasks." },
    { id: "assistant", label: "Assistant", desc: "Autonomous progression." },
  ];
  ...
  <div class="overlay" onclick={onClose} onkeydown={handleKeydown}>
    ...
    <div class="modal" onclick={(e) => e.stopPropagation()} onkeydown={handleKeydown}>
      ...
      <div class="modal-body">
        <p class="hint">Choose the session mode:</p>
