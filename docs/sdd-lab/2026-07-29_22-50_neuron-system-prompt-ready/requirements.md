...
- weight: optional and ignored; system always creates with weight 0 (scores only via later evaluation).
...
> Reverse Sync（2026-08-01）：创建权重规则以 `docs/sdd-lab/2026-08-01_00-31_neuron-create-weight-zero/` 为准。
